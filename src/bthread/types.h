...
inline std::ostream& operator<<(std::ostream& os, bthread_key_t key) {
    return os << "bthread_key_t{index=" << key.index
              << " version=" << key.version << '}';
}
#endif  // __cplusplus
...
// of such bthreads.
static const bthread_attr_t BTHREAD_ATTR_PTHREAD = {BTHREAD_STACKTYPE_PTHREAD,
                                                    0, NULL};
...
static const bthread_attr_t BTHREAD_ATTR_SMALL  = {BTHREAD_STACKTYPE_SMALL, 0,
                                                  NULL};
static const bthread_attr_t BTHREAD_ATTR_NORMAL = {BTHREAD_STACKTYPE_NORMAL, 0,
                                                   NULL};
...
static const bthread_attr_t BTHREAD_ATTR_DEBUG = {
    ...
    BTHREAD_LOG_START_AND_FINISH | BTHREAD_LOG_CONTEXT_SWITCH, NULL};
