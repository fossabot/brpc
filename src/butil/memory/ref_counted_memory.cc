...
const unsigned char* RefCountedStaticMemory::front() const { return data_; }
...
size_t RefCountedBytes::size() const { return data_.size(); }
...
size_t RefCountedString::size() const { return data_.size(); }
...
RefCountedMallocedMemory::~RefCountedMallocedMemory() { free(data_); }
