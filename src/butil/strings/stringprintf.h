...
BUTIL_EXPORT void StringAppendV(std::string* dst, const char* format,
                                va_list ap) PRINTF_FORMAT(2, 0);
#if !defined(OS_ANDROID)
BUTIL_EXPORT void StringAppendV(std::wstring* dst, const wchar_t* format,
