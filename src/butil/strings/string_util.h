...
public:
    bool operator()(Char x, Char y) const {
        // TODO(darin): Do we really want to do locale sensitive comparisons
        // here? See http://crbug.com/24917
...
BUTIL_EXPORT string16 CollapseWhitespace(const string16& text,
...
BUTIL_EXPORT bool LowerCaseEqualsASCII(butil::string16::const_iterator a_begin,
                                       ...
                                       const char* b);
BUTIL_EXPORT bool LowerCaseEqualsASCII(const char* a_begin, const char* a_end,
                                       const char* b);
...
BUTIL_EXPORT bool EqualsASCII(const butil::string16& a,
                              const butil::StringPiece& b);
...
BUTIL_EXPORT bool EndsWith(const std::string& str, const std::string& search,
                           bool case_sensitive);
BUTIL_EXPORT bool EndsWith(const butil::string16& str,
                           const butil::string16& search, bool case_sensitive);
...
BUTIL_EXPORT void ReplaceFirstSubstringAfterOffset(
    butil::string16* str, size_t start_offset, const butil::string16& find_this,
    const butil::string16& replace_with);
BUTIL_EXPORT void ReplaceFirstSubstringAfterOffset(
    std::string* str, size_t start_offset, const std::string& find_this,
    const std::string& replace_with);
...
BUTIL_EXPORT butil::string16 JoinString(
    const std::vector<butil::string16>& parts, butil::char16 s);
BUTIL_EXPORT std::string JoinString(const std::vector<std::string>& parts,
                                    char s);
...
BUTIL_EXPORT butil::string16 ReplaceStringPlaceholders(
    ...
    const std::vector<butil::string16>& subst, std::vector<size_t>* offsets);

BUTIL_EXPORT std::string ReplaceStringPlaceholders(
    const butil::StringPiece& format_string,
    const std::vector<std::string>& subst, std::vector<size_t>* offsets);

// Single-string shortcut for ReplaceStringHolders. |offset| may be NULL.
BUTIL_EXPORT butil::string16 ReplaceStringPlaceholders(
    const butil::string16& format_string, const butil::string16& a,
    size_t* offset);
