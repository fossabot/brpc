...
string16 WideToUTF16(const std::wstring& wide) { return wide; }
...
std::wstring UTF16ToWide(const string16& utf16) { return utf16; }
...
string16 UTF8ToUTF16(const StringPiece& utf8) { return UTF8ToWide(utf8); }

bool UTF16ToUTF8(const char16* src, size_t src_len, std::string* output) {
    return WideToUTF8(src, src_len, output);
}

std::string UTF16ToUTF8(const string16& utf16) { return WideToUTF8(utf16); }
