...
// static
Environment* Environment::Create() { return new EnvironmentImpl(); }
...
string16 AlterEnvironment(const wchar_t* env, const EnvironmentMap& changes) {
    ...
    // An additional null marks the end of the list. We always need a
    // double-null in case nothing was added above.
