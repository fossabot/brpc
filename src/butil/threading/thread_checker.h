...
// butil::NonThreadSafe, but it is meant to be held as a member variable, rather
// than inherited from butil::NonThreadSafe.
//
// While inheriting from butil::NonThreadSafe may give a clear indication about
