...
private:
    ...
    friend class browser_sync::
        NonFrontendDataTypeController;           // http://crbug.com/19757
    ...
    // FIXME(gejun): ScopedAllowWait can't be accessed by
    // SequencedWorkerPool::Inner in gcc 3.4 (SequencedWorkerPool is a friend
    // class)
#if __GNUC__ == 3
public:
#endif
    ...
    // can use this through friend. If you find yourself needing to use this,
    // find another way. Talk to jam or brettw.
