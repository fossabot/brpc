...
public:
    ...
    // Note: this function will throw an import not found (StackWalk64)
    // exception on system without dbghelp 5.1.
...
// appended.
BUTIL_EXPORT char* itoa_r(intptr_t i, char* buf, size_t sz, int base,
                          size_t padding);
