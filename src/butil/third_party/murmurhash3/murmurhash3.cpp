...
void MurmurHash3_x86_128_Update(MurmurHash3_x86_128_Context* ctx,
...
void MurmurHash3_x86_128_Final(void* out,
                               const MurmurHash3_x86_128_Context* ctx) {
    uint32_t h1   = ctx->h1;
    uint32_t h2   = ctx->h2;
    uint32_t h3   = ctx->h3;
    uint32_t h4   = ctx->h4;
...
void MurmurHash3_x64_128_Update(MurmurHash3_x64_128_Context* ctx,
                                const void* key, int len) {
    uint64_t h1 = ctx->h1;
    uint64_t h2 = ctx->h2;
...
void MurmurHash3_x64_128_Final(void* out,
                               const MurmurHash3_x64_128_Context* ctx) {
    uint64_t h1        = ctx->h1;
    uint64_t h2        = ctx->h2;
...
void MurmurHash3_x86_32_Update(MurmurHash3_x86_32_Context* ctx, const void* key,
                               int len) {
    uint32_t h1         = ctx->h1;
    const uint32_t c1   = 0xcc9e2d51;
    const uint32_t c2   = 0x1b873593;
...
void MurmurHash3_x86_32_Final(void* out,
                              const MurmurHash3_x86_32_Context* ctx) {
    const uint32_t c1 = 0xcc9e2d51;
    const uint32_t c2 = 0x1b873593;
    uint32_t h1       = ctx->h1;
