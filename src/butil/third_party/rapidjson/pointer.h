...
public:
    ...
    */
    struct Token {
        const Ch* name;   //!< Name of the token. It has null character at the
                          //!< end but it can contain null character.
    ...
    */
    GenericPointer Append(SizeType index, Allocator* allocator = 0) const {
        char buffer[21];
        SizeType length =
            (sizeof(SizeType) == 4 ? internal::u32toa(index, buffer)
    ...
    */
    ...
    /*!
        ...
        \param allocator Allocator for creating the values if the specified
       value or its parents are not exist. \param alreadyExist If non-null, it
       stores whether the resolved value is already exist. \return The resolved
       newly created, or already exists value.
    */
    ...
    */
    ...
    /*!
        \tparam T \tparam T Either \ref Type, \c int, \c unsigned, \c int64_t,
       \c uint64_t, \c bool
    */
    template <typename T>
    ...
    */
    ...
    /*!
    \tparam T \tparam T Either \ref Type, \c int, \c unsigned, \c int64_t, \c
    uint64_t, \c bool
    */
    template <typename T, typename stackAllocator>
    RAPIDJSON_DISABLEIF_RETURN((internal::OrExpr<internal::IsPointer<T>,
