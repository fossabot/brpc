...
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 6/72/55/35 [ value =
...
//  Sequentially erasing 10000 from
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 6/99/52/43 [ value =
//  8 bytes ] Randomly inserting 100 into
...
//  takes 8/158/126/37 Randomly inserting 1000 into
...
//  takes 6/153/135/36 Randomly inserting 10000 into
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 12/223/180/55
//  Randomly erasing 10000 from
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 7/237/210/48 [ value
//  = 32 bytes ] Randomly inserting 100 into
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 16/179/108/57
//  Randomly erasing 100 from FlatMap/std::map/butil::PooledMap/butil::hash_map
//  takes 5/157/120/38 Randomly inserting 1000 into
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 15/168/127/54
//  Randomly erasing 1000 from FlatMap/std::map/butil::PooledMap/butil::hash_map
//  takes 5/164/135/39 Randomly inserting 10000 into
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 19/241/201/56
//  Randomly erasing 10000 from
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 5/235/218/54 [ value
//  = 128 bytes ] Randomly inserting 100 into
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 35/242/154/97
//  Randomly erasing 100 from FlatMap/std::map/butil::PooledMap/butil::hash_map
//  takes 7/185/119/56 Randomly inserting 1000 into
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 35/262/182/99
//  Randomly erasing 1000 from FlatMap/std::map/butil::PooledMap/butil::hash_map
//  takes 6/215/157/66 Randomly inserting 10000 into
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 44/330/278/114
//  Randomly erasing 10000 from
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 6/307/242/90 [ value
//  = 8 bytes ] Seeking 100 from
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 6/51/52/13 Seeking
//  1000 from FlatMap/std::map/butil::PooledMap/butil::hash_map takes 4/98/82/14
//  Seeking 10000 from FlatMap/std::map/butil::PooledMap/butil::hash_map takes
//  4/175/170/14 [ value = 32 bytes ] Seeking 100 from
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 3/52/52/14 Seeking
//  1000 from FlatMap/std::map/butil::PooledMap/butil::hash_map takes 3/84/82/13
//  Seeking 10000 from FlatMap/std::map/butil::PooledMap/butil::hash_map takes
//  3/164/156/14 [ value = 128 bytes ] Seeking 100 from
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 3/54/53/14 Seeking
//  1000 from FlatMap/std::map/butil::PooledMap/butil::hash_map takes 4/88/90/13
//  Seeking 10000 from FlatMap/std::map/butil::PooledMap/butil::hash_map takes
//  4/178/185/14 [ value = 8 bytes ] Seeking 100 from
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 5/51/49/14 Seeking
//  1000 from FlatMap/std::map/butil::PooledMap/butil::hash_map takes 4/86/94/14
//  Seeking 10000 from FlatMap/std::map/butil::PooledMap/butil::hash_map takes
//  4/177/171/14 [ value = 32 bytes ] Seeking 100 from
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 3/51/53/14 Seeking
//  1000 from FlatMap/std::map/butil::PooledMap/butil::hash_map takes 3/98/82/13
//  Seeking 10000 from FlatMap/std::map/butil::PooledMap/butil::hash_map takes
//  3/163/156/14 [ value = 128 bytes ] Seeking 100 from
//  FlatMap/std::map/butil::PooledMap/butil::hash_map takes 3/55/53/14 Seeking
//  1000 from FlatMap/std::map/butil::PooledMap/butil::hash_map takes 4/88/89/13
//  Seeking 10000 from FlatMap/std::map/butil::PooledMap/butil::hash_map takes
//  4/177/185/14
...
template <typename _K, typename _T,
          ...
          typename _Equal = DefaultEqualTo<_K>, bool _Sparse = false>
class FlatMap {
public:
    typedef _K key_type;
...
private:
    ...
    template <typename _Map, typename _Element>
    friend class SparseFlatMapIterator;
...
template <typename _K, typename _Hash = DefaultHasher<_K>,
          typename _Equal = DefaultEqualTo<_K>, bool _Sparse = false>
class FlatSet {
public:
    ...
    template <typename K2>
    size_t erase(const K2& key) {
        return _map.erase(key, NULL);
    }
    ...
    template <typename K2>
    const void* seek(const K2& key) const {
        return _map.seek(key);
    }
...
template <typename _K, typename _T, typename _Hash = DefaultHasher<_K>,
...
struct DefaultHasher<std::string> {
    std::size_t operator()(const butil::StringPiece& s) const {
        std::size_t result = 0;
        for (butil::StringPiece::const_iterator i = s.begin(); i != s.end();
             ++i) {
            result = result * 101 + *i;
        }
        return result;
...
template <typename _T, typename _Hash, typename _Equal, bool _Sparse>
const _T* find_lowered_cstr(
    const FlatMap<std::string, _T, _Hash, _Equal, _Sparse>& m, const char* key,
    size_t length) {
