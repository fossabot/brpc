...
inline bool value_invalid(const google::protobuf::FieldDescriptor* field,
                          const char* type,
...
inline bool convert_float_type(const BUTIL_RAPIDJSON_NAMESPACE::Value& item,
                               bool repeated,
                               google::protobuf::Message* message,
                               const google::protobuf::FieldDescriptor* field,
                               const google::protobuf::Reflection* reflection,
...
inline bool convert_double_type(const BUTIL_RAPIDJSON_NAMESPACE::Value& item,
                                bool repeated,
                                google::protobuf::Message* message,
                                const google::protobuf::FieldDescriptor* field,
                                const google::protobuf::Reflection* reflection,
...
inline bool convert_enum_type(const BUTIL_RAPIDJSON_NAMESPACE::Value& item,
                              bool repeated, google::protobuf::Message* message,
                              const google::protobuf::FieldDescriptor* field,
                              const google::protobuf::Reflection* reflection,
                              std::string* err) {
    ...
    if (item.IsInt()) {
        ...
        enum_value_descriptor =
            field->enum_type()->FindValueByName(item.GetString());
    }
...
inline bool convert_int64_type(const BUTIL_RAPIDJSON_NAMESPACE::Value& item,
                               bool repeated,
                               google::protobuf::Message* message,
                               const google::protobuf::FieldDescriptor* field,
                               const google::protobuf::Reflection* reflection,
...
// int                             int uint int64 uint64        valid convert is
// available uint                            int uint int64 uint64        valid
// convert is available int64                           int uint int64 uint64
// valid convert is available uint64                          int uint int64
// uint64        valid convert is available int uint int64 uint64           float
// double                 available "NaN" "Infinity" "-Infinity"    float double
//only "NaN" "Infinity" "-Infinity" is available int enum valid enum number
// value is available string                          enum valid enum name value
// is available string                          int64 uint64 valid convert is
// available other mismatch type convertion will be regarded as error.
...
static bool JsonValueToProtoField(
    const BUTIL_RAPIDJSON_NAMESPACE::Value& value,
    const google::protobuf::FieldDescriptor* field,
    google::protobuf::Message* message, const Json2PbOptions& options,
    std::string* err) {
    if (value.IsNull()) {
...
#undef CASE_FIELD_TYPE
    ...
    case google::protobuf::FieldDescriptor::CPPTYPE_UINT64:
        ...
        } else if (!convert_uint64_type(value, false, message, field,
                                        reflection, err)) {
            return false;
        }
        break;
    ...
    case google::protobuf::FieldDescriptor::CPPTYPE_FLOAT:
        if (field->is_repeated()) {
            ...
            for (BUTIL_RAPIDJSON_NAMESPACE::SizeType index = 0; index < size;
                 ++index) {
                const BUTIL_RAPIDJSON_NAMESPACE::Value& item = value[index];
                if (!convert_float_type(item, true, message, field, reflection,
                                        err)) {
                    return false;
                }
            }
        } else if (!convert_float_type(value, false, message, field, reflection,
                                       err)) {
            return false;
        }
        break;
    ...
    case google::protobuf::FieldDescriptor::CPPTYPE_DOUBLE:
        if (field->is_repeated()) {
            ...
            for (BUTIL_RAPIDJSON_NAMESPACE::SizeType index = 0; index < size;
                 ++index) {
                const BUTIL_RAPIDJSON_NAMESPACE::Value& item = value[index];
                if (!convert_double_type(item, true, message, field, reflection,
                                         err)) {
                    return false;
                }
            }
    ...
    case google::protobuf::FieldDescriptor::CPPTYPE_ENUM:
        if (field->is_repeated()) {
            ...
            for (BUTIL_RAPIDJSON_NAMESPACE::SizeType index = 0; index < size;
                 ++index) {
                const BUTIL_RAPIDJSON_NAMESPACE::Value& item = value[index];
                if (!convert_enum_type(item, true, message, field, reflection,
                                       err)) {
                    return false;
                }
            }
        } else if (!convert_enum_type(value, false, message, field, reflection,
                                      err)) {
            return false;
        }
        break;
            ...
            for (BUTIL_RAPIDJSON_NAMESPACE::SizeType index = 0; index < size;
                ...
                if (TYPE_MATCH == J2PCHECKTYPE(item, message, Object)) {
                    if (!JsonValueToProtoMessage(
                       ...
                       value, reflection->MutableMessage(message, field),
                       options, err)) {
            return false;
        }
        break;
...
bool JsonMapToProtoMap(const BUTIL_RAPIDJSON_NAMESPACE::Value& value,
    ...
    for (BUTIL_RAPIDJSON_NAMESPACE::Value::ConstMemberIterator it =
        ...
        google::protobuf::Message* entry =
            reflection->AddMessage(message, map_desc);
...
bool JsonValueToProtoMessage(const BUTIL_RAPIDJSON_NAMESPACE::Value& json_value,
    ...
    for (size_t i = 0; i < fields.size(); ++i) {
        ...
        const std::string& field_name_str =
            (res ? field_name_str_temp : orig_name);
...
bool JsonToProtoMessage(const std::string& json_string,
                        google::protobuf::Message* message,
                        const Json2PbOptions& options, std::string* error) {
